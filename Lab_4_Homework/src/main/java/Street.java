...
public class Street implements Comparable<Street>{
    ...
    private int nrOfAdjacentStreets;
    ...
    public int getNrOfAdjacentStreets() {
        nrOfAdjacentStreets=i1.getNumberOfStreets()+i2.getNumberOfStreets()-2;
        return nrOfAdjacentStreets;
    }
